...
export const summary = pgTable("summary", {
    ...
    // FI fields
    fiInvoiceNumber: varchar("fi_invoice_number", { length: 100 }),
    fiInvoiceDate: varchar("fi_invoice_date", { length: 100 }),
    fiDuePaymentDate: varchar("fi_due_payment_date", { length: 100 }),
    fiInvoiceLineItemTotal: varchar("fi_invoice_line_item_total", { length: 100 }),
    fiFreight: varchar("fi_freight", { length: 100 }),
    fiInvoiceTotal: varchar("fi_invoice_total", { length: 100 }),
    ...
    insuranceDeclaredCertNo: varchar("insurance_declared_cert_no", { length: 100 }),
    // BL fields
    blReference: varchar("bl_reference", { length: 100 }),

    // Export PFI fields
    exportPfiNumber: varchar("export_pfi_number", { length: 100 }),
    eleV8Code: varchar("eleV8Code", { length: 100 }),


    // Export Insurance fields
    exportInsuranceDateOfIssue: varchar("export_insurance_date_of_issue", { length: 100 }),
    exportInsuranceDeclaredCertNo: varchar("export_insurance_declared_cert_no", { length: 100 }),
    exportInsurancePremiumAmount: varchar("export_insurance_premium_amount", { length: 100 }),
